...
nrep = 1 # increase number of repeatitions for repeated trials
nIter = 100 # increase number of iterations for repeated trials

# M1: Functions (Likelihood calculation) ---------------------------------------------------------------
...
# M2 Functions (likelihood calculation) ------------------------------------------------------------
...
# Compare the two model (fixed \varepsilon) -----------------------------------------------------------------
M1_varying_epsilon
M2_varying_epsilon
